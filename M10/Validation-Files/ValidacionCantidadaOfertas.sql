...
SELECT
	COUNT(*)
FROM
	DESA_CLIENTES.RU.APP_M10_TMP_ALLOCATION_FILE_OP A--2988791
;

SELECT
	COUNT(DISTINCT A.OFFER_ID)
FROM
	DESA_CLIENTES.RU.APP_M10_TMP_ALLOCATION_FILE_OP A--131
;

SELECT
	COUNT(DISTINCT A.OFFER_ID)
FROM
	DESA_CLIENTES.RU.APP_M10_TMP_ALLOCATION_FILE_PC A--97
;

SELECT
	COUNT(DISTINCT A.CUSTOMER_ID)
FROM
	DESA_CLIENTES.RU.APP_M10_TMP_ALLOCATION_FILE_OP A--782865
;
