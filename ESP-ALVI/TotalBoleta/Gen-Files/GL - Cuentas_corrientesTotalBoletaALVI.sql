...
SELECT 
	...
	--A.CUENTA_CORRIENTE||';'||SUBSTR(A.CUENTA_CORRIENTE,13,5) AS TEST
FROM--SELECT * FROM
...
FROM --SELECT * FROM
	DESA_CLIENTES.SG.STG_INPUT_BANDA_TOTAL_BOLETA_FUGADOS_ALVI A
INNER JOIN
	DESA_CLIENTES.CT.APP_ALVI_TOTAL_BOLETA_OFERTAS B
ON
