...
SELECT 
	...
	, COUNT(*)
FROM
	DESA_CLIENTES.CT.TMP_TB_APP_M10_TMP_ALLOCATION_FILE_NEW A--272
;--8	487018
...
SELECT
	*
FROM
	NZ_CLIENTES.STG.TMP_STG_OUTPUT_DIGITAL_FILE_OFFER_TB_ALVI A
WHERE
...
SELECT
	*
FROM
	DESA_CLIENTES.RU.TMP_STG_OUTPUT_DIGITAL_FILE_OFFER_TB_M10 A
;--8             
SELECT
	*
FROM
