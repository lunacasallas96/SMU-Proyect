...
INSERT INTO DESA_CLIENTES.RU.APP_TOTAL_BOLETA_CUENTAS_CORRIENTES 
...
SELECT 
	...
	, 1 AS MULTIPLICADOR
FROM--SELECT * FROM
	DESA_CLIENTES.RU.APP_TOTAL_BOLETA_CUENTAS_CORRIENTES  A
INNER JOIN
	(
		...
		FROM
			DESA_CLIENTES.RU.APP_TOTAL_BOLETA_CUENTAS_CORRIENTES 
		--END REGION
	) B
ON
...
FROM  --select * from
	DESA_CLIENTES.CT.APP_M10_TOTAL_BOLETA_OFERTAS TBO 
